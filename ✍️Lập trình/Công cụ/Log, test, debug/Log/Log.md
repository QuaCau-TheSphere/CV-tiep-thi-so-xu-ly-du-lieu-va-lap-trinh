...
Bấm <kbd>Ctrl + Alt + L</kbd> (Windows) hoặc <kbd>Ctrl + Option + L</kbd>(Mac) để đọc `console.log()` nhanh:

![alt text](https://image.ibb.co/dysw7p/insert_log_message.gif)
![Multiple cursor](https://i.ibb.co/Jk2pmRG/tcl-multiple-selections.gif "Multiple cursor support")

## [Cowsay](https://jsr.io/@morinokami/deno-says)
