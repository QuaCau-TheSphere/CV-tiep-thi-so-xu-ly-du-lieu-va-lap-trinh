...
---
[[Nếu như code giống như các nốt nhạc, thì động cơ giống như nhạc công, còn môi trường thực thi giống như nhạc cụ|Nếu xem code giống như các nốt nhạc trên một tờ giấy, thì engine giống như nhạc công, còn môi trường thực thi giống như nhạc cụ]]. Trình duyệt là một môi trường thực thi. Node, Deno, Bun cũng là những môi trường thực thi. Nhưng [[JavaScript vốn được sinh ra để chạy trên trình duyệt và không được dùng để làm việc với lượng code lớn|JS vốn được sinh ra để chạy trên trình duyệt]], nên nó không quan tâm gì đến máy.
