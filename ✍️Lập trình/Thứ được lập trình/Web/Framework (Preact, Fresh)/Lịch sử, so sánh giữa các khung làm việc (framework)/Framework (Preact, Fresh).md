...
![React for Two Computers \| Dan Abramov - YouTube](https://youtu.be/ozI4V_29fj4?si=bdgGiz_TXESV9Rvu)

```dataview
LIST rows.file.link
FROM "✍️Lập trình/Thứ được lập trình/Web/Framework (Preact, Fresh)" 
