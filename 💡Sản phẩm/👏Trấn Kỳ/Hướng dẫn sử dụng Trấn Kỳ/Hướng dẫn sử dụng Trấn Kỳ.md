...
```dataview
list
from "👏Trấn Kỳ/Hướng dẫn sử dụng Trấn Kỳ/1. Cài đặt và sử dụng nhanh" 
```

# 2. Thiết lập chương trình
```dataview
list
from "👏Trấn Kỳ/Hướng dẫn sử dụng Trấn Kỳ/2. Thiết lập chương trình" 
```
# 3. Hiểu code nói gì
```dataview
list
from "👏Trấn Kỳ/Hướng dẫn sử dụng Trấn Kỳ/3. Hiểu code nói gì" 
```
